...
$course_name = 'python programming'; // Specify the course name to filter
...
<center><h1 style="background-color: pink;">Python programming Course Students List</h1></center>
